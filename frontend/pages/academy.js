    ...
    return (
        <>
            <Layout>
                ...
                <GS.FullWidth>
                    <GS.ImageBackground
                        background={`url('/ftgu-academy-man.webp')`}
                    >
                        <GS.MaxContainer>
                        ...
                        <GS.MaxContainer>
                            <Fade cascade>
                                <Callouts>
                                    <div>
                                        <BsNewspaper />
                                        Worksheets to follow and build your
                                        brand
                                    </div>
                                    <div>
                                        <GiSmartphone />
                                        Access through our mobile app- from
                                ...
                                <Callouts>
                                    <div>
                                        <GiRolledCloth />
                                        Premium vendors and suppliers to help
                                        you build your product line
                                    </div>
                                    <div>
                                        <MdPeople />
                                        Your membership unlocks future updates
                                        to our training course
                                    </div>
                                </Callouts>
                            </Fade>
                        </GS.MaxContainer>
                        ...
                        <GS.YCPadding padding={'10rem'}>
                            <Included>
                                <div>
                                    <Photo
                                        src={
                                            '/ftgu-academy-whats-included-700x1000.jpg'
                                        }
                                    />
                                </div>
                                <div>
                ...
                <GS.FullWidth>
                    <GS.ImageBackground
                        background={`url('/ftgu-academy-choose-plan.jpg')`}
                    >
                        <GS.MaxContainer>
                            <GS.YCPadding padding={'10rem'}>
                                <Fade>
                                    <Heading>
                                        Are you ready to start building from the
                                        ground up?
                                    </Heading>
                                    <GS.Center>
                                        <Link
